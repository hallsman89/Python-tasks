...
class TestCondition:
        ...
        [
            ...
            (
                ...
                50,
                {
                    ...
                    "pupillary dilation": 100 / 50,
                },
            ),
        ],
    )
    def test_get_avg_condition(
        self, r: int, hr: int, bl: int, pd: int, count: int, expected: dict[str, float]
    ) -> None:
    ...
    def test_is_valid_indicator(
        self, indicator: Any, min_value: int, max_value: int, expected: bool
    ) -> None:
        ...
        """
        assert (
            self.condition.is_valid_indicator(indicator, min_value, max_value)
            == expected
        )
    ...
    def test_get_indicator(
        ...
        assert self.condition.get_indicator(min_value, max_value, text) == expected
