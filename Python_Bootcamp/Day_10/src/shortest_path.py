...
def get_non_directed_graph(graph: dict) -> dict:
...
def get_graph(directed: bool = False) -> dict:
    ...
    return graph if not directed else get_non_directed_graph(graph)


def get_path(
    graph: dict, start: str = FROM_DEFAULT, end: str = TO_DEFAULT
) -> list[str]:
